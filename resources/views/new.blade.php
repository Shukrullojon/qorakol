        ...
        <div class="container header-container">
            ...
            <div class="header-rigt-box">
                <a href="tel:712030056" class="header-tell">
                    <img class="header-tell-img" src="{{ asset("a/images/phone-vector.svg")}}" alt="phone" width="24" height="24">
                    71 203 00 56
                </a>
                <span class="header-left-line"></span>
...
<main>
        ...
        <section class="work">
            <div class="container work-container">
                <div class="work-title-box">
                    <span class="about-title-line"></span>
                    <h3 class="work-title">@lang('front.work_1') <span class="work-title-span">@lang('front.work_2')</span></h3>
                </div>
                <ul class="work-list">
    ...
    @if(count($jobs))
        <section class="our-jobs">
            <div class="container">
                <div style=" margin: 0px; margin-bottom: 64px; display: flex; align-items: center; justify-content: space-between;">
                ...
                <ul class="our-jobs-list">
                    <li class="our-jobs-item" id="ourJobsItem1">
                        <img style="margin-bottom: 26px;" src="./images/mb-white-icon.svg" alt="icon" width="111" height="85">
                    ...
                    <li id="jobsItem">
                        <div class="our-jobs-item our-jobs-item-box" id="ourJobsItem4">
                            <img style=" margin-bottom: 4px;" src="./images/murad-building-icon.svg" alt="icon" width="88" height="74">
                            <h3 class="our-jobs-item-title">Murad Buildings -1000</h3>
                            <p class="our-jobs-item-desc">Tashkent, Uzbekistan</p>
                        </div>
                                ...
                                @foreach($reviews as $review)
                                    <article class="cCarousel-item">
                                        ...
                                        <button class="about-customr-video-play" id="aboutCustomerVideoBtn{{ $m++ }}">
                                            <svg class="about-customr-video-play-img" width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M28.5 46.752V25.248C28.5004 24.9789 28.5733 24.715 28.7108 24.4837C28.8483 24.2525 29.0455 24.0625 29.2817 23.9336C29.5179 23.8048 29.7844 23.7419 30.0533 23.7514C30.3222 23.761 30.5835 23.8427 30.81 23.988L47.538 34.737C47.7498 34.8727 47.9241 35.0595 48.0448 35.2802C48.1655 35.5009 48.2288 35.7484 48.2288 36C48.2288 36.2516 48.1655 36.4991 48.0448 36.7198C47.9241 36.9405 47.7498 37.1273 47.538 37.263L30.81 48.015C30.5835 48.1603 30.3222 48.242 30.0533 48.2515C29.7844 48.2611 29.5179 48.1982 29.2817 48.0693C29.0455 47.9405 28.8483 47.7505 28.7108 47.5193C28.5733 47.288 28.5004 47.024 28.5 46.755V46.752Z" fill="white"/>
                                                <path d="M3 36C3 17.775 17.775 3 36 3C54.225 3 69 17.775 69 36C69 54.225 54.225 69 36 69C17.775 69 3 54.225 3 36ZM36 7.5C28.4413 7.5 21.1922 10.5027 15.8475 15.8475C10.5027 21.1922 7.5 28.4413 7.5 36C7.5 43.5587 10.5027 50.8078 15.8475 56.1525C21.1922 61.4973 28.4413 64.5 36 64.5C43.5587 64.5 50.8078 61.4973 56.1525 56.1525C61.4973 50.8078 64.5 43.5587 64.5 36C64.5 28.4413 61.4973 21.1922 56.1525 15.8475C50.8078 10.5027 43.5587 7.5 36 7.5Z" fill="white"/>
                                            </svg>
                                        </button>
...
<div class="our-work-modal hidden" id="ourWorkModal">
    <div class="modal ">
        ...
        <div class="modal-box">
            ...
            <p class="modal-desc">
                <span class="modal-desc-span">Arif Solar, Arif International Holdingning energetika yo'nalishidagi sho' ba korxonasi xisoblanadi. </span>Korxonamizning quyosh elektr stansiyalarini qurishuchun dunyoning eng sifatli barcha hom ashyo va mahsulotlarni olib kelish va o'rnatish bilan shug'ullanadi.
                Asosiy magsadlarimizdan biri O'zbekistonda gaytatiklanuvchi elektr energiya manbaylarini ko'paytirish orgali, tabiatga keltirilayotgan zararlarni kamaytirish!
            </p>
        </div>
    </div>
