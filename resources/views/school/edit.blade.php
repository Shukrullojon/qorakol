        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::model($school, ['method' => 'PATCH','route' => ['school.update', $school->id], 'enctype' => 'multipart/form-data']) !!}
                        <div class="row">

                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label for="name"><strong>Malumot:</strong></label>{!! Form::label('name',"*",['style'=>"color:red"]) !!}
