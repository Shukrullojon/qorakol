            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Consultation Management</h3>

                        <a href="{{ route('consultation.create') }}" class="btn btn-success btn-sm float-right">
                            ...
                            @foreach($consultations as $consultation)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a class="" href="{{ route('consultation.show',$consultation->id) }}"
                                               style="margin-right: 7px">
                                                <span class="fa fa-eye"></span>
                                            </a>

                                            <a class="" href="{{ route('consultation.edit',$consultation->id) }}"
