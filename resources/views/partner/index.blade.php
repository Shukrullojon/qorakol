            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Hamkorlarimiz</h3>

                        <a href="{{ route('partner.create') }}" class="btn btn-success btn-sm float-right">
                            ...
                            @foreach($partners as $partner)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a class="" href="{{ route('partner.show',$partner->id) }}" style="margin-right: 7px">
                                                <span class="fa fa-eye"></span>
                                            </a>

                                            <a class="" href="{{ route('partner.edit',$partner->id) }}" style="margin-right: 2px">
